...
public class Out {
  ...
  /** Print the line number of the caller, followed by the Object o,
   and terminate the line. */
  public static void debug(Object o) {
    int line_number = Thread.currentThread().getStackTrace()[2].getLineNumber();
    System.out.print("\033[35m"); // PURPLE
    getOut().printf("Line number %d: ", line_number);
    println(o);
    newLinePrinted();

...
pattern:    
            .word   
    0x002000000x00004000, 0x00000080,     0x00000001, 0x00000002, 0x00000004, 0x00000008, 0x00000400, 0x00020000, 0x01000000, 0x02000000, 0x04000000
loopcnt:    .word   0x001e8484, 0x001e8484, 0x001e8484, 0x001e8484
...
wait:       
    ...
    lw      $t3,        loopcnt($t1)                                                                                                                    # read the loop counter
    beq     $t2,        $t3,            forward

 ...
 * using the {@link #getFunction()} method. To plot the function (and display
...
public class PlotterWindow {
    ...
    private volatile String function = "sin(x)";
    ...
    private JPanel createInputPanel() {
        ...
        panel.add(new JLabel("Function: y ="), BorderLayout.WEST);
        
        JTextField textField = new JTextField();
        textField.setText(function);
        textField.addKeyListener(new KeyAdapter(){
            public void keyReleased(KeyEvent e) {
                function = ((JTextField) e.getComponent()).getText();
            }
        });
    ...
    /**
     * Returns the text that is currently in the function input field.
     */

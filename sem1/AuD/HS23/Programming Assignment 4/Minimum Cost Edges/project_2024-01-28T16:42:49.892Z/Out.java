...
public class Out {
  ...
  private static boolean bypass; // bypass file opening and closing
  
  public static void setBypass(boolean arg) {
    bypass = arg;
  }
  ...
  public static void initialize(PrintStream newOut) {
    out_initialized = true;
    try{
      out = new PrintStream(newOut, true, "UTF-8");
    } catch (UnsupportedEncodingException e) {
      // no worry, UTF-8 is fine.
    }
    done = true;
